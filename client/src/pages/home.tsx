...
function LeadMagnetSection() {
  ...
  return (
    <section className="py-4 lg:py-6 bg-gradient-to-br from-primary/10 via-primary/5 to-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-48 relative">
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative min-h-[65vh] lg:min-h-[70vh] flex items-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-48 pt-16 lg:pt-24 pb-10 lg:pb-16 w-full">
        ...
        <section className="py-6 lg:py-10 bg-gradient-to-br from-primary via-primary to-primary/90 text-primary-foreground">
          <div className="max-w-7xl mx-auto px-48 text-center">
