...
const allServices = [
  { 
    ...
    icon: HomeIcon, 
    image: completeImg,
    imageAlt: "Komplettsanierung München Altbau – Wohnung und Haus komplett sanieren lassen vom Meisterbetrieb mit Festpreisgarantie",
  ...
  { 
    ...
    icon: Bath, 
    image: bathroomImg,
    imageAlt: "Badsanierung München – Bad komplett sanieren lassen mit bodengleicher Dusche und barrierefreiem Umbau vom Fachbetrieb",
  ...
  { 
    ...
    image: kitchenImg,
    imageAlt: "Küchensanierung München – Küche renovieren lassen mit neuer Elektrik, Fliesen und Wasseranschlüssen vom Handwerkerbetrieb",
  ...
  { 
    ...
    icon: Layers, 
    image: floorImg,
    imageAlt: "Bodensanierung München – Parkett verlegen, Fußbodenheizung einbauen und Estrich erneuern lassen vom Fachbetrieb",
  ...
  { 
    ...
    icon: Zap, 
    image: electricImg,
    imageAlt: "Elektrosanierung München – Elektrik erneuern, neue Leitungen verlegen und Sicherungskasten austauschen lassen VDE-konform",
  ...
  { 
    ...
    icon: Flame, 
    image: heatingImg,
    imageAlt: "Heizungssanierung München – Wärmepumpe einbauen, Fußbodenheizung nachrüsten und alte Heizung austauschen lassen",
