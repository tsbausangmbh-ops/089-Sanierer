            ...
            <Link href="/">
              <div className="flex items-center gap-3 cursor-pointer">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-lg leading-tight">KSHW München</span>
                  <span className="text-xs text-white/70">Komplettsanierungen Haus & Wohnung</span>
                </div>
              </div>
            </Link>
            <Link href="/">
              <Button variant="outline" size="sm" className="text-white border-white/30 hover:bg-white/10" data-testid="button-back-home">
      ...
      <footer className="pt-12 pb-6 bg-[hsl(220,75%,22%)] text-white">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li><Link href="/anfrage" className="hover:text-white">Komplettsanierung</Link></li>
                <li><Link href="/anfrage" className="hover:text-white">Badsanierung</Link></li>
                <li><Link href="/anfrage" className="hover:text-white">Küchensanierung</Link></li>
                <li><Link href="/gewerke" className="hover:text-white">Handwerker-Vermittlung</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold mb-4">Kontakt</h4>
              <ul className="space-y-2 text-sm text-white/70">
                <li>Telefon: 0152 122 740 43</li>
                <li>E-Mail: info@089-sanierer.de</li>
          ...
          <div className="mt-8 pt-6 border-t border-white/20 text-center text-sm text-white/60">
            <p>&copy; 2024 KSHW München. Alle Rechte vorbehalten.</p>
          </div>
        </div>
      </footer>
    </div>
