...
import rechnerImg from "@assets/generated_images/expert_renovation_advisor.png";
      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-[65vh] lg:min-h-[70vh] flex items-center overflow-hidden">
          <div 
            ...
            style={{ backgroundImage: `url(${rechnerImg})` }}
          >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-24 pt-16 lg:pt-24 pb-10 lg:pb-16 w-full">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/15 backdrop-blur-md rounded-full text-white text-sm mb-4 border border-white/20">
                ...
                <span>Kostenloser Online-Rechner</span>
              </div>
              
              <h1 className="text-3xl lg:text-5xl font-bold text-white mb-4 leading-tight">
                Was kostet Ihre Sanierung? <br />
                <span className="text-orange-400">Jetzt kostenlos berechnen.</span>
              </h1>
              
              <div className="text-lg lg:text-xl text-white/90 mb-5 max-w-lg flex flex-col gap-0.5">
                <span>Wohnung, Haus oder Förderung.</span>
                <span>Alle Leistungen wählbar.</span>
                <strong className="text-white">Münchner Marktpreise 2026.</strong>
              </div>

              <p className="text-white/90 text-sm mb-3 font-medium">
                Unverbindlich und in wenigen Klicks - Ihr individueller Kostenvoranschlag.
              </p>

              <div className="flex flex-col sm:flex-row gap-3 mb-5">
                <Button 
                  size="lg" 
                  onClick={() => document.getElementById('rechner-start')?.scrollIntoView({ behavior: 'smooth' })}
                  ...
                  data-testid="button-rechner-start"
                >
                ...
                <a href="tel:+498944438872">
                  <Button 
                    ...
                    data-testid="button-phone-rechner"
                  >
