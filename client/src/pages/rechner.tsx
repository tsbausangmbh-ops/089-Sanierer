...
const rechnerHeroContent: HeroContent = {
  ...
  mobileImageSrc: "/images/mobile/kostenrechner_planung_2026.webp",
...
export default function RechnerPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
                ...
                <div className="text-center">
                  ...
                  <Button 
                    ...
                    className={propertyType === "foerderung" 
                      ? "bg-green-600 hover:bg-green-700 text-white min-h-14 w-full sm:w-auto px-6 sm:px-8 text-xs sm:text-sm"
                      : "bg-orange-500 hover:bg-orange-600 text-white min-h-14 w-full sm:w-auto px-6 sm:px-8 text-xs sm:text-sm"
                    }
                  ...
                  <div className="max-w-2xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-4">
                      <Link href={getAnfrageUrl()}>
                        <Button 
                          size="lg" 
                          className={`min-h-14 w-full sm:w-auto px-6 sm:px-8 text-xs sm:text-sm font-semibold shadow-xl ${
                            propertyType === "foerderung" 
                      ...
                      <a href="tel:+498944438872">
                        <Button size="lg" variant="outline" className="min-h-14 w-full sm:w-auto px-6 text-xs sm:text-sm">
        ...
        <section className={`py-6 lg:py-10 ${propertyType === "foerderung" ? "bg-green-600" : "bg-primary"} text-white`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href={getAnfrageUrl()}>
                <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white min-h-14 w-full sm:w-auto px-6 sm:px-8 text-xs sm:text-sm font-semibold shadow-xl" data-testid="button-anfrage-cta">
      ...
      <InternalLinks links={linkSets.fromRechner} />
      <SeoFooter />
    </div>
  );
}
