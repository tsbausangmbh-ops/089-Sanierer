...
const serviceHeroContents: Record<string, HeroContent> = {
  komplettsanierung: {
    ...
    titleLine2: "Ein Ansprechpartner. Ein Festpreis.",
  ...
  badsanierung: {
    ...
    titleLine2: "In 10-15 Werktagen Ihr Traumbad.",
  ...
  kuechensanierung: {
    ...
    titleLine2: "Elektrik, Wasser, Fliesen – perfekt.",
  ...
  bodensanierung: {
    ...
    titleLine2: "Parkett, Fliesen, Vinyl – Meisterqualität.",
  ...
  elektrosanierung: {
    ...
    titleLine2: "Sicher, normgerecht, zukunftssicher.",
