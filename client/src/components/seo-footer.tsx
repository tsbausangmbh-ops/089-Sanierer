...
export function SeoFooter() {
  return (
    <footer className="pt-12 pb-6 bg-gradient-to-r from-[hsl(220,80%,18%)] to-[hsl(220,60%,32%)] text-white" role="contentinfo" itemScope itemType="https://schema.org/WPFooter">
