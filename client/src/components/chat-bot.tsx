...
import { MessageCircle, X, Send, Bot, User, Phone, Calendar, Euro, HelpCircle } from "lucide-react";
    ...
    return (
      <div className="fixed bottom-32 right-6 z-50 flex items-center gap-3">
        <div className="bg-[hsl(220,75%,25%)] text-white shadow-lg rounded-2xl px-4 py-2">
          ...
          <p className="text-xs opacity-90">Beratung und Tipps rund um die Uhr</p>
        </div>
