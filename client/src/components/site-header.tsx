    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[hsl(220,80%,10%)] text-white border-b border-white/20">
      ...
      <div className="w-full px-6 sm:px-10 lg:px-16">
        <div className="h-16 flex items-center justify-between gap-4">
          ...
          <nav className="hidden min-[1400px]:flex items-center gap-1" aria-label="Hauptnavigation">
            <DropdownMenu>
      ...
      {mobileMenuOpen && (
        <nav 
          id="mobile-menu"
          className="min-[1400px]:hidden bg-[hsl(220,80%,12%)] border-t border-white/10"
